...
### Changed
- Add support for field-level `_meta` in mappings; `meta` is deprecated as an alias; field metadata validation was relaxed ([#19884](https://github.com/opensearch-project/OpenSearch/issues/19884))
